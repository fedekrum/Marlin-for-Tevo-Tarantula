...
#define CUSTOM_MACHINE_NAME "Tevo Tarantula FK" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 85.67
  #define DEFAULT_bedKi 5.71
  #define DEFAULT_bedKd 856.22
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 95.24 }
